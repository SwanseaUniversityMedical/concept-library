...
#======== change password ==============================================================================
# use Django form (for non-SAIL users)
urlpatterns += [
    url(
        '^change-password/$',
...
urlpatterns += [
    url(r'^admin/uc/$', adminTemp.check_concepts_not_associated_with_phenotypes, name='check_concepts_not_associated_with_phenotypes-uc'),
    #url(r'^admin/concepts_not_in_phenotypes/$', adminTemp.check_concepts_not_associated_with_phenotypes, name='check_concepts_not_associated_with_phenotypes'),
]
