    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[(1, 'simple (% only)'), (2, 'POSIX regex')]),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='component_type',
            field=models.IntegerField(
                choices=[(1, 'Concept'), (2, 'Query Builder'), (
                    3, 'Expression'), (4, 'Select/Import')]),
        ),
        migrations.AlterField(
            model_name='component',
            name='concept_ref',
        ...
        migrations.AlterField(
            model_name='component',
            name='logical_type',
            field=models.IntegerField(choices=[(1, 'Add codes'),
                                               (2, 'Remove codes')],
                                      default=1),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='concept',
            name='group_access',
            field=models.IntegerField(choices=[(1, 'No Access'), (2, 'View'),
                                               (3, 'Edit')],
                                      default=1),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='display',
            field=models.IntegerField(choices=[(1, 'default'), (2, 'primary'),
                                               (3, 'success'), (4, 'info'),
                                               (5, 'warning'), (6, 'danger')],
                                      default=1),
        ),
        migrations.AlterField(
            model_name='historicaltag',
            name='tag_type',
            field=models.IntegerField(choices=[(1, 'tag'), (2, 'collection')],
                                      default=1),
        ),
        migrations.AlterField(
