# Generated by Django 4.0.7 on 2023-03-03 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_prefix', models.CharField(editable=False, max_length=4, null=True)),
                ('entity_id', models.IntegerField(editable=False, null=True, unique=True)),
                ...
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='entity_deleted', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_filters', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), blank=True, editable=False, null=True, size=None)),
                ('entity_order', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), blank=True, editable=False, null=True, size=None)),
                ('entity_statistics', models.JSONField(blank=True, default=dict, editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(blank=True, db_index=True)),
                ('entity_prefix', models.CharField(editable=False, max_length=4, null=True)),
                ('entity_id', models.IntegerField(db_index=True, editable=False, null=True)),
                ('name', models.CharField(max_length=250)),
                ('status', models.IntegerField(choices=[(1, 'Draft'), (2, 'Final')], default=1)),
                ('author', models.CharField(max_length=1000)),
                ('definition', models.TextField(blank=True, null=True)),
