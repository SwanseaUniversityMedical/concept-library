...
##Save all of the statistics for each brand in clinical_codestatistics.
# This will confirm if the user has permissions, and then run save_statistics_collections for each brand.
