...
class ComponentExpressionSelectDelete(LoginRequiredMixin,
    ...
    def post(self, request, *args, **kwargs):
        ...
        data['html_history_list'] = render_to_string(
            ...
            {'history': concept.history.all(),
             'current_concept_history_id': concept.history.latest().pk,
             'published_historical_ids': list(PublishedConcept.objects.filter(concept_id=component.concept_id).values_list('concept_history_id', flat=True))             
            },
            request=self.request
            )
...
def component_history_expression_detail_combined(request,
                                                pk,
                                                concept_id,
                                                concept_history_id,
    ...
    return render(request,
                  'clinicalcode/component/expression/detail_combined.html',
                  {
                      'component': component,
                      'coderegex': coderegex,
                      'codelist': codelist,
...
def component_history_expressionselect_detail_combined(request,
                                                      pk,
                                                      concept_id,
                                                      concept_history_id,
                                                      component_history_id):
