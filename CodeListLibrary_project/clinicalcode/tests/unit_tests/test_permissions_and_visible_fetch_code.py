...
class PermissionTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.code_list_for_none = CodeList.objects.create(component=cls.component_for_none, description="Code list visibility test")
        cls.code_for_none = Code.objects.create(code_list=cls.code_list_for_none, code="45554", description="visibility test")
        ...
        cls.code_list_for_everybody = CodeList.objects.create(component=cls.component_for_everybody, description="Code list visibility test")
        cls.code_for_everybody = Code.objects.create(code_list=cls.code_list_for_everybody, code="24212", description="visibility test")
        ...
        cls.code_list_for_group = CodeList.objects.create(component=cls.component_for_group, description="Code list visibility test")
        cls.code_for_group = Code.objects.create(code_list=cls.code_list_for_group, code="24212", description="visibility test")
    ...
    def test_normal_user_not_allowed_to_permit_con(self):
        ...
        permitted = allowed_to_permit(user, Concept,
    ...
    def test_group_user_not_allowed_to_permit_con(self):
        ...
        permitted = allowed_to_permit(group, Concept,
                        PermissionTest.concept_everyone_can_edit.id)
        self.assertFalse(permitted)
    ...
    def test_owner_allowed_to_permit_ws(self):
        owner = User.objects.get(username=ow_user)
        permitted = allowed_to_permit(owner, WorkingSet,
    ...
    def test_super_user_allowed_to_permit_ws(self):
        super_user = User.objects.get(username=su_user)
        permitted = allowed_to_permit(super_user, WorkingSet,
                        PermissionTest.workingset_owner_can_edit.id)
        self.assertTrue(permitted)   
    ...
    def test_normal_user_user_visible_code_list_for_everybody(self):
        normal_user = User.objects.get(username=nm_user)
        query = get_visible_codelists(normal_user, self.code_list_for_everybody.id)
    ...
    def test_group_user_visible_code_list_for_everybody(self):
        ...
        query = get_visible_codelists(group_user, self.code_list_for_everybody.id)
    ...
    def test_superuser_visible_code_list_for_everybody(self):
        super_user = User.objects.get(username=su_user)
        query = get_visible_codelists(super_user, self.code_list_for_everybody.id)
    ...
    def test_normal_user_visible_components_for_group(self):
        normal_user = User.objects.get(username=nm_user)
        query = get_visible_components(normal_user, self.component_for_group.id)
        
        self.assertTrue(query.count() == 0)
    
    def test_normal_user_visible_components_for_everybody(self):
        normal_user = User.objects.get(username=nm_user)
        query = get_visible_components(normal_user, self.component_for_everybody.id)
    ...
    def test_group_user_visible_components_for_everybody(self):
        group_user = User.objects.get(username=gp_user)
        query = get_visible_components(group_user, self.component_for_everybody.id)
    ...
    def test_superuser_visible_components_for_everybody(self):
        super_user = User.objects.get(username=su_user)
        query = get_visible_components(super_user, self.component_for_everybody.id)
    ...
    def test_normal_user_visible_concepts(self):
        ...
        self.assertTrue((self.concept_everyone_can_view and self.concept_everyone_can_edit) in query.all()) 
    ...
    def test_group_user_visible_concepts(self):
        ...
        self.assertTrue((self.concept_everyone_can_view and self.concept_everyone_can_edit and
                         self.concept_group_can_edit and self.concept_group_can_view) in query.all()) 
    ...
    def test_normal_user_visible_workingsets(self):
        ...
        # Query should contain two concepts only (concept everybody can view and concept everybody can edit)
        self.assertTrue(query.count() == 2)
        self.assertTrue((self.workingset_everyone_can_view and self.workingset_everyone_can_edit) in query.all()) 
    ...
    def test_group_user_visible_workingsets(self):
        ...
        # concept group can view and concept group can edit
        self.assertTrue(query.count() == 4)
        self.assertTrue((self.workingset_everyone_can_view and self.workingset_everyone_can_edit and
                         self.workingset_group_can_view and self.workingset_group_can_edit) in query.all()) 
