...
class PublishedPhenotype(models.Model):
    ...
    modified_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="published_phenotype_modified") # user of the person who modified this row.
