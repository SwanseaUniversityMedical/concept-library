...
class Concept(TimeStampedModel):
    ...
    )  # Was there any clinical validation of this concept?  1=yes 0=no
    validation_description = models.CharField(
        max_length=3000
    )  # Description of Validation (think about structure of this)
    ...
    )  # Has a paper been published with these codes? 1=yes 0=no
    ...
    coding_system = models.ForeignKey(CodingSystem,
                                      on_delete=models.SET_NULL,
    ...
    code_attribute_header = ArrayField(models.CharField(max_length=100),
                                       blank=True,
                                       null=True)
