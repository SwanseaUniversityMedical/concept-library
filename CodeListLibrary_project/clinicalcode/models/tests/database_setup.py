...
def setUpTestData(cls):
    ...
    component = Component.objects.create(comment="Component 1 inclusion",
                                         component_type=2,
    ...
    code_list = CodeList.objects.create(component=component,
                                        description="Code list 1 inclusion")
    ...
    component2 = Component.objects.create(comment="Component 2 exclusion",
                                          component_type=2,
                                          concept=concept_heart_disease_1,
                                          created_by=user,
                                          logical_type=2,
    ...
    code_list2 = CodeList.objects.create(component=component2,
                                         description="Code list 2 exclusion")
    ...
    component = Component.objects.create(comment="Component 3 inclusion",
                                         component_type=1,
                                         concept=concept_heart_disease_1,
    ...
    component = Component.objects.create(comment="Component 4 exclusion",
                                         component_type=1,
                                         concept=concept_heart_disease_1,
    ...
    component = Component.objects.create(comment="Component 3 exclusion",
                                         component_type=1,
                                         concept=concept_heart_failure_2b,
    ...
    component = Component.objects.create(comment="Component 4 inclusion",
                                         component_type=1,
                                         concept=concept_heart_failure_2b,
    ...
    component = Component.objects.create(comment="Component 5 exclusion",
                                         component_type=1,
                                         concept=circ_system_1,
