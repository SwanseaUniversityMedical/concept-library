...
class CodeRegex(models.Model):
    ...
    REGEX_TYPE_CHOICES = ((SIMPLE, 'simple (% only)'), (POSIX, 'POSIX regex'))
    SEARCH_COLUMN_CHOICES = ((CODE, 'code'), (DESCRIPTION, 'description'))
    ...
    column_search = models.IntegerField(choices=SEARCH_COLUMN_CHOICES,
                                        blank=True,
                                        null=True)
