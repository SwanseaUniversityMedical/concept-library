...
class CodeForm(forms.ModelForm):
    code = forms.CharField(
        ...
        widget=forms.TextInput(attrs={
            'class': 'form-control',
            'data-required': 'please enter a code'
        }))
...
class CodeRegexForm(forms.ModelForm):
    regex_type = forms.ChoiceField(label='Regex type:',
...
CodeRegexFormSet = inlineformset_factory(Component,
                                         CodeRegex,
                                         form=CodeRegexForm)
CodeListFormSet = inlineformset_factory(Component,
                                        CodeList,
                                        form=CodeListForm,
                                        min_num=1,
                                        validate_min=True)
