...
from ..permissions import Permissions, allowed_to_permit
...
class ConceptForm(forms.ModelForm):
    ...
    validation_performed = forms.BooleanField(label='Validation performed:',
                                              required=False)
    ...
    def clean_group(self):
        ...
        if instance.id is None:  # create
            ...
            if allowed_to_permit(self.user, Concept, instance.id):
                ...
                prev_stored_group_access = Concept.objects.filter(
...
class ConceptUploadForm(forms.Form):
    ...
    upload_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'class': 'form-control',
                'data-required': 'please enter an upload name'
            }))
    logical_type = forms.ChoiceField(label='Type:',
    ...
    first_row_has_column_headings = forms.BooleanField(
        label='Has column names in the first row', required=False)
...
class Tag(forms.ModelForm):
    description = forms.CharField(
        ...
        widget=forms.TextInput(attrs={
            'class': 'form-control',
            'data-required': 'Please enter a description'
        }))
