...
class OPCS4_CODES_AND_TITLES(models.Model):
    ...
    code_without_decimal = models.CharField(max_length=50, null=True, blank=True)
    title = models.CharField(max_length=255, null=True, blank=True)
    opcs_version = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
