...
from ..forms.CodeForms import CodeRegexFormSet #, CodeListFormSet, CodeForm
...
from ..permissions import (
    ...
    HasAccessToEditParentConceptCheckMixin, HasAccessToViewParentConceptCheckMixin
)
...
class ComponentExpressionCreate(LoginRequiredMixin,
    ...
    def form_invalid(self, form):
        ...
        data['html_form'] = render_to_string('clinicalcode/component/expression/create.html',
    ...
    def form_valid(self, form):
        ...
        if formset.is_valid():
            ...
            db_utils.create_expression_codes(
                ...
                formset.instance.coderegex.regex_code,
                code_list.id,
...
class ComponentExpressionDetail(LoginRequiredMixin,
                                HasAccessToViewParentConceptCheckMixin,
                                DetailView):
    '''
        Produce an expression component detail page.
        This is used in the pop-up displays in the concept components views.
    '''
    model = Component
    template_name = 'clinicalcode/component/expression/detail.html'

    def get_context_data(self, **kwargs):
        context = DetailView.get_context_data(self, **kwargs)
        coderegex = CodeRegex.objects.get(component=self.object)
        context['coderegex'] = coderegex
        if coderegex.code_list is None:
            context['codes'] = []
        else:
            codes = coderegex.code_list.codes.order_by('code')
            data = list(codes.values('code', 'description'))
            context['codes'] = json.dumps(data)
        return context
...
class ComponentExpressionUpdate(LoginRequiredMixin,
    ...
    def form_valid(self, form):
        ...
        if formset.is_valid():
            ...
            data['form_is_valid'] = False
            data['html_form'] = render_to_string('clinicalcode/component/expression/update.html',
                                                 context=self.get_context_data(form=form),
                                                 request=self.request)
...
class ComponentExpressionSelectDetail(LoginRequiredMixin,
                                      HasAccessToViewParentConceptCheckMixin,
                                      DetailView):
    '''
        Produce an expression select component detail page.
        This is used in the pop-up displays in the concept components views.
    '''
    model = Component
    template_name = 'clinicalcode/component/expressionselect/detail.html'
        ...
        if formset.is_valid():
            with transaction.atomic():
                ...
                for code in added_codes:
                    ...
                    if not codes_to_add:
                        Code.objects.create(code_list=CodeList.objects.get(pk=code_list_id),
                                            code=code['code'],
...
@login_required
def component_history_expression_detail(request,
                                        pk,
                                        concept_id,
                                        concept_history_id,
    ...
    coderegex = db_utils.getHistoryCodeRegex(component['id'], concept_history_date)
    codelist = db_utils.getHistoryCodeListById(coderegex['code_list_id'], concept_history_date)
    ...
    return render(request,
                  'clinicalcode/component/expression/history/detail.html',
                  {
                      'component': component,
                      'coderegex': coderegex,
                      'codelist': codelist,
...
def component_expression_searchcodes(request, concept_id):
    ...
    codes = db_utils.search_codes(Component.COMPONENT_TYPE_EXPRESSION,
                                  ...
                                  request.POST.get('search_params'),
...
def component_expressionselect_search_codes(request, concept_id):
    ...
    codes = db_utils.search_codes(Component.COMPONENT_TYPE_EXPRESSION_SELECT,
                                  coding_system.database_connection_name,
                                  coding_system.table_name,
                                  coding_system.code_column_name,
                                  coding_system.desc_column_name,
...
@login_required
def component_history_expressionselect_detail(request,
                                              pk,
                                              concept_id,
                                              concept_history_id,
                                              component_history_id):
    ...
    return render(request,
                  'clinicalcode/component/expressionselect/history/detail.html',
                  {
                      'component': component,
                      'coderegex': coderegex,
                      'codelist': codelist,
