...
# LDAP authentication  ====================================NRDASAILCONTROL_active ===================
AUTH_LDAP_SERVER_URI = "ldap://chi.swan.ac.uk"
AUTH_LDAP_BIND_DN = "CN=Code List User , OU=Application Software, OU=Service Accounts ,DC=chi,DC=swan,DC=ac,DC=uk"

AUTH_LDAP_BIND_PASSWORD = get_env_value('AUTH_LDAP_BIND_PASSWORD')   

AUTH_LDAP_USER_SEARCH = LDAPSearchUnion(
    LDAPSearch("OU=Users, OU=SAIL, OU=NRDA, OU=HIRU,DC=chi,DC=swan,DC=ac,DC=uk", ldap.SCOPE_SUBTREE, "(sAMAccountName=%(user)s)"),
    #LDAPSearch("OU=Users HIRU,OU=HIRU,DC=chi,DC=swan,DC=ac,DC=uk", ldap.SCOPE_SUBTREE, "(sAMAccountName=%(user)s)"),
)
    
# Set up the basic group parameters.
AUTH_LDAP_GROUP_SEARCH = LDAPSearch("OU=SAIL,OU=NRDA,OU=HIRU,DC=chi,DC=swan,DC=ac,DC=uk", ldap.SCOPE_SUBTREE, "(objectClass=groupOfNames)")
AUTH_LDAP_GROUP_TYPE = GroupOfNamesType(name_attr="cn")

# Simple group restrictions
#AUTH_LDAP_REQUIRE_GROUP = "CN=CodeListLibraryUsers,OU=SAIL,OU=NRDA,OU=HIRU,DC=chi,DC=swan,DC=ac,DC=uk"
AUTH_LDAP_REQUIRE_GROUP = "CN=NRDASAILCONTROL_Active,OU=SAIL,OU=NRDA,OU=HIRU,DC=chi,DC=swan,DC=ac,DC=uk"
